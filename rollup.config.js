    ...
    plugins: [
        ...
        // 自定义CSS合并插件（使用postcss处理）
        {
            ...
            async buildStart() {
                ...
                // 处理content CSS
                const contentResult = await postcss(plugins).process(
                    contentCssContent,
                    {
                ...
                // 处理popup CSS
                const popupResult = await postcss(plugins).process(
                    popupCssContent,
                    {
        ...
        // 自动处理HTML中的资源引用
        {
            ...
            writeBundle(options, bundle) {
                ...
                console.log(`Updated HTML references in popup/index.html`)
