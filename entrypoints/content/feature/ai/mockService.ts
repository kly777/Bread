import { AIService, AIResponse, PageAnalysis, HighlightSuggestion } from './aiServiceBase'
...
export class MockAIService extends AIService {
    ...
    async analyzePage(content: string): Promise<PageAnalysis> {
        ...
        return {
            ...
            complexity: content.length > 5000 ? 'complex' : content.length > 2000 ? 'medium' : 'simple',
        }
    }
