...
export const STYLE_COLORS = [
        ['#FFFF80', '#99ccff', '#ff99cc', '#66cc66', '#cc99ff', '#ffcc66', '#66aaaa', '#dd9966', '#aaaaaa', '#dd6699'], // 方案0：明亮色系
        ['#FFFFa0', '#bbeeff', '#ffbbcc', '#88ee88', '#ccbbff', '#ffee88', '#88cccc', '#ffbb88', '#cccccc', '#ffaabb'], // 方案1：柔和色系
        ['#D6E19C', '#A2BFE1', '#DC95BF', '#1FC6B2', '#928AD3', '#E4C994', '#94CCC3', '#D5B87C', '#B2D1D3', '#DD8DB0'], // 方案2：自然色系
        ['#ff7575', '#ff9175', '#ffca75', '#ffff75', '#75ff75', '#75fff1', '#75c1ff', '#757aff', '#d675ff', '#ff75cc'], // 方案3：鲜艳色系
        ['#EBD9CB', '#D8B0B0', '#ACD4D6', '#C3BAB1', '#E7ADAC', '#EBC1A8', '#A6BAAF', '#B98A82', '#e8d1cb', '#DECECE'], // 方案4：复古色系
        ['#FFF36D', '#8DE971', '#FFCD8A', '#FFACB6', '#F3C9E4', '#FF9DE5', '#6DD5C3', '#B29EE7', '#A6DDEA', '#50C2E1']  // 方案5：现代色系
]
...
export const BORDER_COLORS = [
        ['#aaaa20', '#4477aa', '#aa4477', '#117711', '#7744aa', '#aa7711', '#115555', '#884411', '#555555', '#881144'], // 方案0对应的边框色
        ['#aaaa40', '#6699aa', '#aa6699', '#339933', '#9966aa', '#aa9933', '#337777', '#aa6633', '#777777', '#aa3366'], // 方案1对应的边框色
        ['#aeb780', '#869eb9', '#9e6c89', '#158679', '#5f5988', '#8b7b59', '#5e837c', '#8a7750', '#728789', '#955f77'], // 方案2对应的边框色
        ['#be5858', '#b86a56', '#b89254', '#b8b855', '#52b652', '#54b6ac', '#4f85b2', '#4f53b3', '#9450b2', '#ad4e8a'], // 方案3对应的边框色
        ['#ac9f95', '#947878', '#748e8f', '#7f7973', '#956e6e', '#977a6a', '#6a766f', '#6d524d', '#948682', '#928787'], // 方案4对应的边框色
        ['#bbb250', '#62a24f', '#b69160', '#b57980', '#ad8ea2', '#ae679b', '#489285', '#7b6da2', '#6f959e', '#348196']  // 方案5对应的边框色
]
 ...
 * @returns 完整的高亮词配置对象
 */
export function createHighlightWord(text: string, enabled: boolean = true): HighlightWord {
        return {
                text,
                enabled,
